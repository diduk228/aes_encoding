...
void MainWindow::on_un_shif_clicked()
{
    QString str2, result;
    const char* ch;
//    ui->text_shifr->clear(); // очищаем поле, куда будем выводить расшифрованный текст
    uint8_t plain2[32] = {0}; // используется для хранения расшифрованных данных
    const uint8_t key2[]= "..324[24241``";
    QString str = ui->text_unshifr->toPlainText();
    ...
    while(!str.isEmpty())
    {
        ...
        ui->text_unshifr->setText(result);
    }
}
